...
export default function VetAddClientScreen() {
  const insets = useSafeAreaInsets();
  const topInset = Platform.OS === 'web' ? 67 : insets.top;
  const bottomInset = Platform.OS === 'web' ? 34 : insets.bottom;
  const { addVetClient, acceptInviteCode, vetClients, userName } = usePets();
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <ScrollView
          contentContainerStyle={[styles.content, { paddingTop: topInset + 16, paddingBottom: bottomInset + 40 }]}
        ...
        >
          ...
          <View style={styles.heroSection}>
            ...
            <Text style={styles.subtitle}>
              Enter the client and pet information below
            </Text>
          </View>
